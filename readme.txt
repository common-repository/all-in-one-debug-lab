...
Contributors: Karampaglidis Panagiotis
Tags: debug, debug log, error log,  wp-config, develop, error notification, debug notification, bug report, display error, find bug
...
1. Click "Add New" and Search for "All-in-One Debug Lab"
